...
import { Rocket, Mail, Lock, Eye, EyeOff, LogIn, PieChart, Brain } from "lucide-react";
            ...
            >
              ...
              <div>
                <h3 className="text-sm font-bold flex items-center gap-2">
                  {feature.title}
                  {feature.special && <span className="text-[10px] bg-gradient-to-r from-indigo-500 to-purple-500 px-1.5 py-0.5 rounded-full uppercase tracking-wider">New</span>}
                </h3>
          ...
          <form onSubmit={handleLogin} className="space-y-4">
            ...
            >
              ...
              <div className="relative flex justify-center text-[10px] uppercase tracking-widest">
                <span className="bg-[#08081a] px-2 text-white/30">Or continue with</span>
              </div>
            </motion.div>
            ...
            <motion.button
              ...
              className="w-full bg-white/5 border border-white/10 py-3 rounded-lg font-bold text-sm hover:bg-white/10 transition-all flex items-center justify-center gap-2"
            >
